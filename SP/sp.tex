...
\begin{figure}[h]
	...
	\begin{tikzpicture}[framed]
		...
		(2,0) circle (1.5cm) node[anchor=west, text width=1.8cm,yshift=0.2cm] {Markov processes} (1,-1.5) circle (1.5cm) node[anchor=north] {Martingle tools};
		\node[anchor=south,yshift=-2.3cm,xshift=-0.5cm,red] at (current bounding box.north) {$BM$};
	\end{tikzpicture}
\end{figure}
