...
\end{revise}
\begin{fancyproof}
	$\Gamma$ is symmetric, so there exists an orthogonal $U$ such that $\Gamma=UDU^{\trsp}$ with $D=\mathsf{diag}(\ubracketthin{\lambda_{1},\ldots,\lambda_{n}}_{\claptext{eigenvalues}})$
\end{fancyproof}
\listoffigures  
\end{document} 
