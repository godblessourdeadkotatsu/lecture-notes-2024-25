...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{img/screenshot064}
	\caption{Please bro just one more simulation please bro now the ergodic average will be good please bro just one more run it's only 3000 nested loops to generate a gazillion-dimensional vector please bro}
