...
\begin{fancyproof}
	...
	\begin{equation*}
		...
		\end{bmatrix}.
	\end{equation*}
	Consider $M\Delta=\Gamma$. We have a linear transformation of a Gaussian vector $\Delta$. Hence the BMs (that have a finite dimensional distribution) are Gaussian. But if all finite dimensional distributions of the process are Gaussian, then the BM is Gaussian.
\end{fancyproof}
\clearpage
\listoffigures  
\end{document} 
