...
The issue with simulating a Brownian path with a computer is that time is continuous. We will make use of the above properties to simulate a one-dimensional \bwm{} and a $d$-dimensional in general.
\listoffigures  
\end{document} 
