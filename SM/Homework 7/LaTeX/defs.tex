...
\newminted{python}{mathescape, linenos, numbersep=5pt, frame=single, breaklines,bgcolor=gray!9, fontfamily=courier,python3,rulecolor=Emerald,numbersep=5pt,label=Python,xleftmargin=0pt}
\newenvironment{ccode}{\VerbatimEnvironment\begin{pythoncode}}{\end{pythoncode}}
