...
\end{verbatim}
Here the point estimate is tragically higher than the expected value in the previous exercise and than what the MVA suggested. A possible explanation of this fact may lie in the \emph{different variances} of the two distributions:
\end{document}
